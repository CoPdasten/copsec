...
type LogEvent struct {
	...
	TargetPid        int32                  `protobuf:"varint,10,opt,name=target_pid,json=targetPid,proto3" json:"target_pid,omitempty"`
	TargetComm       string                 `protobuf:"bytes,11,opt,name=target_comm,json=targetComm,proto3" json:"target_comm,omitempty"`
...
func (x *LogEvent) GetTargetPid() int32 {
	if x != nil {
		return x.TargetPid
	}
	return 0
...
func (x *LogEvent) GetTargetComm() string {
	if x != nil {
		return x.TargetComm
	}
	return ""
...
const file_copsec_proto_rawDesc = "" +
	"\n" +
	"\fcopsec.proto\x12\x06copsec\"\xe1\x02\n" +
	"\bLogEvent\x12\x17\n" +
	...
	"\n" +
	"target_pid\x18\n" +
	" \x01(\x05R\ttargetPid\x12\x1f\n" +
	"\vtarget_comm\x18\v \x01(\tR\n" +
	"targetComm\"h\n" +
	"\tStreamAck\x12\x18\n" +
	...
	"\x11active_bans_count\x18\x05 \x01(\x05R\x0factiveBansCount\x12\x1d\n" +
	"\n" +
	"node_group\x18\x06 \x01(\tR\tnodeGroup\x12\x1d\n" +
	"\n" +
	"ip_address\x18\a \x01(\tR\tipAddress\x12)\n" +
	"\x10active_interface\x18\b \x01(\tR\x0factiveInterface\x12\x1d\n" +
	"\n" +
	"xdp_status\x18\t \x01(\tR\txdpStatus\x122\n" +
	"\x15total_packets_dropped\x18\n" +
	" \x01(\x03R\x13totalPacketsDropped\"k\n" +
